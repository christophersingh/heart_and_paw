    ...
    jQuery.ajax({
        ...
        success:function(data) {
            ...
            if(resultData.error && resultData.content) {
                ...
                // SHOW PAGINATION BUTTONS IF NEEDED
                if(prevButton || nextButton) {
                    paginationButtons = '<div class="cm-submitted-forms-pagination-wrapper"><div class="cm-submitted-forms-total-count">' + totalResults + ' Records Found</div><div class="cm-submitted-forms-pagination grid_row">' + prevButton + resultsCount + nextButton + '</div></div>';
                }
