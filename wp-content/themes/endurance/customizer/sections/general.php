    ...
    $general_sections['general'] = array(
        ...
        'options'   => array(
            ...
            'endurance-display-dynamic-menu' => array(
                ...
                'control'               => array(
                    'label'             => __( 'Display Dynamic Menu in Sidebar of Pages', 'endurance' ),
                    'type'              => 'checkbox'
                )
            ),
            ...
            'endurance-display-featured-hero' => array(
                ...
                'control'               => array(
                    'label'             => __( 'Display Featured Images on Single Pages', 'endurance' ),
                    'type'              => 'checkbox'
                )
            ),
            ...
            'endurance-display-featured-parent-title' => array(
                ...
                'control'               => array(
                    'label'             => __( 'Display Parent Page Title', 'endurance' ),
