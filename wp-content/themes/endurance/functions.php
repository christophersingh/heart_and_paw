...
function endurance_setup() {
	...
	if ( is_admin() && isset( $_GET['activated'] ) ) {
		add_action( 'admin_notices', 'endurance_activation_notice' );
	}
...
function endurance_js_scripts() {
	...
	// Theme stylesheet.
	wp_enqueue_style( 'endurance-style', get_stylesheet_uri() );
	...
	if (! is_admin()) {
		...
		wp_register_script( 'endurance-scripts', get_template_directory_uri() . '/js/endurance.js', array( 'jquery' ), '20180502', true );
